# JPGovAI - ISO 42001認証準備 & AIガバナンス管理 SaaS

経済産業省・総務省「AI事業者ガイドライン（第1.1版, 2025年3月）」に準拠した
ISO/IEC 42001:2023 AIMS認証取得を支援するSaaSプロトタイプ。
...
4. **レポート生成**: ISO 42001 Certification申請用の自己評価レポートをPDF出力
